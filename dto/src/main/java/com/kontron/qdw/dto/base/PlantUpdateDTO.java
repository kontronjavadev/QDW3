...
public class PlantUpdateDTO implements Serializable {
     ...
     */
    @Generated
    public PlantUpdateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public PlantUpdateDTO(String code, String shortText, String comment, boolean active, LocalDateTime creationDate, LocalDateTime lastUpdate,
            int version) {
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (PlantUpdateDTO) obj;
