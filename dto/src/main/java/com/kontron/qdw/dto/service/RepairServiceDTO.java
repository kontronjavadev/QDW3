...
public class RepairServiceDTO implements Serializable {
     ...
     */
    @Generated
    public RepairServiceDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairServiceDTO(String name, String code) {
        this.name = name;
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairServiceDTO(String name, String code, String shortText, String comment, LocalDateTime creationDate, LocalDateTime lastUpdate,
            int version) {
        this.name = name;
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (RepairServiceDTO) obj;
