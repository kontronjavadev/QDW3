...
public class RepairServiceUpdateDTO implements Serializable {
    @Generated
     ...
     */
    @Generated
    public RepairServiceUpdateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairServiceUpdateDTO(String name, String code) {
        this.name = name;
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairServiceUpdateDTO(String name, String code, String shortText, String comment, LocalDateTime creationDate, LocalDateTime lastUpdate,
            int version) {
        this.name = name;
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (RepairServiceUpdateDTO) obj;
