...
public class EWSEntryUpdateDTO implements Serializable {
    @Generated
    ...
    @Generated
    public static final String ATTR_RECEIVERS = "receivers";
    @Generated
    ...
    @Generated
    private Collection<UserListDTO> receivers = new ArrayList<>();

    /**
     * Default constructor
     */
    @Generated
    public EWSEntryUpdateDTO() {
    }
     ...
     */
    @Generated
    public EWSEntryUpdateDTO(long id) {
        this.id = id;
    }
     ...
     */
    @Generated
    public EWSEntryUpdateDTO(double threshold, boolean boardOrSystem, String filterCriterion, EWSType type, long id, int version,
     ...
     */
    @Generated
    public Collection<UserListDTO> getReceivers() {
     ...
     */
    @Generated
    public void setReceivers(Collection<UserListDTO> receivers) {
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (EWSEntryUpdateDTO) obj;
