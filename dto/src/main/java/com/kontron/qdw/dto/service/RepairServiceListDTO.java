...
public class RepairServiceListDTO implements Serializable {
    @Generated
     ...
     */
    @Generated
    public RepairServiceListDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairServiceListDTO(String code, String name) {
        this.code = code;
        this.name = name;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (RepairServiceListDTO) obj;
