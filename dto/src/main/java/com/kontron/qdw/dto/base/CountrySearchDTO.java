...
public class CountrySearchDTO implements Serializable {
    @Generated
     ...
     */
    @Generated
    public CountrySearchDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public CountrySearchDTO(String name, String code) {
        this.name = name;
        this.code = code;
    }
     ...
     */
    @Generated
    public CountrySearchDTO(String name, String code, String shortText, String comment, boolean active, LocalDateTime creationDate,
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (CountrySearchDTO) obj;
