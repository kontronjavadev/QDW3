...
public class UserUpdateDTO implements Serializable {
     ...
     */
    @Generated
    public UserUpdateDTO(String name, long id) {
        this.name = name;
        this.id = id;
    }
     ...
     */
    @Generated
    public UserUpdateDTO(String name, String email, boolean active, long id, int version, LocalDateTime creationDate, LocalDateTime lastUpdate) {
        this.name = name;
        this.email = email;
        this.active = active;
        this.id = id;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (UserUpdateDTO) obj;
