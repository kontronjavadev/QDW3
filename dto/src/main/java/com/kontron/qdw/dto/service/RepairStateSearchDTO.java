...
public class RepairStateSearchDTO implements Serializable {
    @Generated
     ...
     */
    @Generated
    public RepairStateSearchDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairStateSearchDTO(String name, String code) {
        this.name = name;
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairStateSearchDTO(String name, String code, String shortText, String comment, LocalDateTime creationDate, LocalDateTime lastUpdate) {
        this.name = name;
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (RepairStateSearchDTO) obj;
