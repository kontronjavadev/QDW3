...
public class CountryCreateDTO implements Serializable {
     ...
     */
    @Generated
    public CountryCreateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public CountryCreateDTO(String name, String code, String shortText, String comment, boolean active, LocalDateTime creationDate, int version) {
        this.name = name;
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (CountryCreateDTO) obj;
