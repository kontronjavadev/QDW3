...
public class SupplierCreateDTO implements Serializable {
     ...
     */
    @Generated
    public SupplierCreateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public SupplierCreateDTO(String name, String code) {
        this.name = name;
        this.code = code;
    }
     ...
     */
    @Generated
    public SupplierCreateDTO(String name, String street, String zipCode, String city, String code, String shortText, String comment,
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (SupplierCreateDTO) obj;
