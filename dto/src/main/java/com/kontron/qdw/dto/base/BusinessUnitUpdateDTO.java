...
public class BusinessUnitUpdateDTO implements Serializable {
    @Generated
     ...
     */
    @Generated
    public BusinessUnitUpdateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public BusinessUnitUpdateDTO(String code, String shortText, String comment, boolean active, LocalDateTime creationDate, LocalDateTime lastUpdate,
            int version) {
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (BusinessUnitUpdateDTO) obj;
