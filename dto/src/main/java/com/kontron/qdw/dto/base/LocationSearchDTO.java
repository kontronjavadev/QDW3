...
public class LocationSearchDTO implements Serializable {
     ...
     */
    @Generated
    public LocationSearchDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public LocationSearchDTO(String code, String shortText, String comment, boolean active, LocalDateTime creationDate, LocalDateTime lastUpdate) {
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (LocationSearchDTO) obj;
