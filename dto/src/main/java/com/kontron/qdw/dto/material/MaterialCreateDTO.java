...
public class MaterialCreateDTO implements Serializable {
     ...
     */
    @Generated
    public MaterialCreateDTO(long id) {
        this.id = id;
    }
     ...
     */
    @Generated
    public MaterialCreateDTO(String materialNumber, long id) {
     ...
     */
    @Generated
    public MaterialCreateDTO(String materialNumber, String sapNumber, String shortText, String comment, Double fitValue, String materialHierarchy,
            boolean searchSubAssemblies, long id, int version, LocalDateTime creationDate) {
        this.materialNumber = materialNumber;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (MaterialCreateDTO) obj;
