...
public class RepairErrorCodeListDTO implements Serializable {
    @Generated
     ...
     */
    @Generated
    public RepairErrorCodeListDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairErrorCodeListDTO(String code, String name) {
        this.code = code;
        this.name = name;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (RepairErrorCodeListDTO) obj;
