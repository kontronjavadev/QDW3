...
public class SupplierSearchDTO implements Serializable {
     ...
     */
    @Generated
    public SupplierSearchDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public SupplierSearchDTO(String name, String code) {
        this.name = name;
        this.code = code;
    }
     ...
     */
    @Generated
    public SupplierSearchDTO(String name, String street, String zipCode, String city, String code, String shortText, String comment,
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (SupplierSearchDTO) obj;
