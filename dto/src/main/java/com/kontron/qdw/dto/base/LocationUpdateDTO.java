...
public class LocationUpdateDTO implements Serializable {
     ...
     */
    @Generated
    public LocationUpdateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public LocationUpdateDTO(String code, String shortText, String comment, boolean active, LocalDateTime creationDate, LocalDateTime lastUpdate,
            int version) {
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (LocationUpdateDTO) obj;
