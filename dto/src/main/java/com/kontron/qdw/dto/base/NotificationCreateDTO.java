...
public class NotificationCreateDTO implements Serializable {
     ...
     */
    @Generated
    public NotificationCreateDTO(long id) {
        this.id = id;
    }
     ...
     */
    @Generated
    public NotificationCreateDTO(String header, String notification, LocalDateTime notificationStart, LocalDateTime notificationEnd, long id,
            int version, LocalDateTime creationDate) {
        this.header = header;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (NotificationCreateDTO) obj;
