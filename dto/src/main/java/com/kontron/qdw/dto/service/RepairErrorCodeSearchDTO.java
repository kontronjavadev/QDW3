...
public class RepairErrorCodeSearchDTO implements Serializable {
    @Generated
    ...
    @Generated
    public static final String SELECT_GROUPNAME = "a.groupName";
    @Generated
     ...
     */
    @Generated
    public RepairErrorCodeSearchDTO() {
    }
     ...
     */
    @Generated
    public RepairErrorCodeSearchDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairErrorCodeSearchDTO(String name, String code) {
        this.name = name;
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairErrorCodeSearchDTO(String name, String groupName, String code, String shortText, String comment, boolean active,
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (RepairErrorCodeSearchDTO) obj;
