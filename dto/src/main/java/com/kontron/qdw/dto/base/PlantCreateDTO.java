...
public class PlantCreateDTO implements Serializable {
     ...
     */
    @Generated
    public PlantCreateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public PlantCreateDTO(String code, String shortText, String comment, boolean active, LocalDateTime creationDate, int version) {
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (PlantCreateDTO) obj;
