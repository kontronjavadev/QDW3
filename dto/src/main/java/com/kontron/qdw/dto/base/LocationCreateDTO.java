...
public class LocationCreateDTO implements Serializable {
     ...
     */
    @Generated
    public LocationCreateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public LocationCreateDTO(String code, String shortText, String comment, boolean active, LocalDateTime creationDate, int version) {
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (LocationCreateDTO) obj;
