...
public class RepairStateListDTO implements Serializable {
    @Generated
     ...
     */
    @Generated
    public RepairStateListDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairStateListDTO(String code, String name) {
        this.code = code;
        this.name = name;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (RepairStateListDTO) obj;
