...
public class RepairLocationDTO implements Serializable {
    @Generated
     ...
     */
    @Generated
    public RepairLocationDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairLocationDTO(String code, String shortText, String comment, LocalDateTime creationDate, LocalDateTime lastUpdate, int version) {
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (RepairLocationDTO) obj;
