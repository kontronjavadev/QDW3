...
public class MovementTypeCreateDTO implements Serializable {
    @Generated
     ...
     */
    @Generated
    public MovementTypeCreateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public MovementTypeCreateDTO(String code, String shortText, String comment, boolean active, LocalDateTime creationDate, int version) {
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (MovementTypeCreateDTO) obj;
