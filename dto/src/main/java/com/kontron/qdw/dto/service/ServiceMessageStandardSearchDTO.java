...
public class ServiceMessageStandardSearchDTO implements Serializable {
    @Generated
    ...
    @Generated
    public static final String ATTR_SERVORDCUSTOMERCODE = "servordCustomerCode";
    @Generated
    public static final String ATTR_SERVORDCUSTOMERNAME = "servordCustomerName";
    @Generated
    public static final String ATTR_SERVORDCUSTCOUNTRYCODE = "servordCustCountryCode";
    @Generated
    public static final String ATTR_SERVORDCUSTCOUNTRYNAME = "servordCustCountryName";
    @Generated
    ...
    @Generated
    public static final String ATTR_SERVICEORDERCOMMENT = "serviceOrderComment";
    @Generated
    ...
    @Generated
    public static final String SELECT_SERVORDCUSTOMERCODE = "p.code";
    @Generated
    public static final String SELECT_SERVORDCUSTOMERNAME = "p.name";
    @Generated
    public static final String SELECT_SERVORDCUSTCOUNTRYCODE = "w.code";
    @Generated
    public static final String SELECT_SERVORDCUSTCOUNTRYNAME = "w.name";
    @Generated
    public static final String SELECT_MATREVMATERIALID = "z.id";
    @Generated
    public static final String SELECT_MATREVMATMATERIALNUMBER = "z.materialNumber";
    @Generated
    public static final String SELECT_MATREVMATSAPNUMBER = "z.sapNumber";
    @Generated
    public static final String SELECT_MATREVMATSHORTTEXT = "z.shortText";
    @Generated
    ...
    @Generated
    public static final String SELECT_SERVICEORDERCOMMENT = "f.comment";
    @Generated
    ...
    @Generated
    private String servordCustomerCode;
    @Generated
    private String servordCustomerName;
    @Generated
    private String servordCustCountryCode;
    @Generated
    private String servordCustCountryName;
    @Generated
     ...
     */
    @Generated
    public ServiceMessageStandardSearchDTO() {
    }
     ...
     */
    @Generated
    public ServiceMessageStandardSearchDTO(long id) {
        this.id = id;
    }
     ...
     * @param servordCustomerCode
     * @param servordCustomerName
     * @param servordCustCountryCode
     * @param servordCustCountryName
     ...
     */
    @Generated
    public ServiceMessageStandardSearchDTO(String analysisText, LocalDate basicFinishDate, LocalDate basicStartDate, String causeText,
            boolean customerFailure, String customerReport, String defectComponent, String deliveryNoteNumber, String designator,
            boolean epidemicFailure, String errorId, String externalReport, LocalDate internalArrivalDate, String internalReport,
            LocalDate internalShipmentDate, String origin, String repairDescription, String serviceMessageId, long id, LocalDateTime creationDate,
            LocalDateTime lastUpdate, String plantCode, String serviceOrderCode, String repairStateName, String repairStateCode,
            long materialRevisionId, long serialObjectId, String serialObjectSerialNumber, String servordCustomerCode, String servordCustomerName,
            String servordCustCountryCode, String servordCustCountryName, long matrevMaterialId, String matrevMatMaterialNumber,
            String matrevMatSapNumber, String matrevMatShortText, String matrevMatOwnerLocationCode, String matrevMatMaterialTypeCode,
            String matrevMatMaterialClassCode, String matrevRevisionNumber, String serviceOrderComment, String repairErrorCodeCode,
            String repairErrorCodeGroupName, String repairErrorCodeName, String repairErrorCodeShortText, String repairLocationCode,
            String rMATypeCode, String repairServiceCode, String repairServiceName, String faultAnalysisCode, String faultAnalysisShortText,
            String repairTaskCode, String repairTaskShortText, String externalSupplierCode, String externalSupplierName) {
        ...
        this.servordCustomerCode = servordCustomerCode;
        this.servordCustomerName = servordCustomerName;
        this.servordCustCountryCode = servordCustCountryCode;
        this.servordCustCountryName = servordCustCountryName;
        ...
        this.serviceOrderComment = serviceOrderComment;
     ...
     */
    @Generated
    public String getServordCustomerCode() {
        return this.servordCustomerCode;
    }

    /**
     * @param servordCustomerCode the code of the customer to set
     */
    @Generated
    public void setServordCustomerCode(String servordCustomerCode) {
        this.servordCustomerCode = servordCustomerCode;
    }
     ...
     */
    @Generated
    public String getServordCustomerName() {
        return this.servordCustomerName;
    }

    /**
     * @param servordCustomerName the name of the customer to set
     */
    @Generated
    public void setServordCustomerName(String servordCustomerName) {
        this.servordCustomerName = servordCustomerName;
    }
     ...
     */
    @Generated
    public String getServordCustCountryCode() {
        return this.servordCustCountryCode;
    }

    /**
     * @param servordCustCountryCode the code of the country to set
     */
    @Generated
    public void setServordCustCountryCode(String servordCustCountryCode) {
        this.servordCustCountryCode = servordCustCountryCode;
    }
     ...
     */
    @Generated
    public String getServordCustCountryName() {
        return this.servordCustCountryName;
    }

    /**
     * @param servordCustCountryName the name of the country to set
     */
    @Generated
    public void setServordCustCountryName(String servordCustCountryName) {
        this.servordCustCountryName = servordCustCountryName;
    }
    ...
    /**
     * @return the comment of the service order
     */
    @Generated
    public String getServiceOrderComment() {
        return this.serviceOrderComment;
    }

    /**
     * @param serviceOrderComment the comment of the service order to set
     */
    @Generated
    public void setServiceOrderComment(String serviceOrderComment) {
        this.serviceOrderComment = serviceOrderComment;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (ServiceMessageStandardSearchDTO) obj;
