...
public class SupplierUpdateDTO implements Serializable {
     ...
     */
    @Generated
    public SupplierUpdateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public SupplierUpdateDTO(String name, String code) {
        this.name = name;
        this.code = code;
    }
     ...
     */
    @Generated
    public SupplierUpdateDTO(String name, String street, String zipCode, String city, String code, String shortText, String comment,
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (SupplierUpdateDTO) obj;
