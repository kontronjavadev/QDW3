...
public class RepairErrorCodeCreateDTO implements Serializable {
    @Generated
    ...
    @Generated
    public static final String ATTR_MAPPEDTO = "mappedTo";
    @Generated
    private String name;
    @Generated
    ...
    private int version;
    @Generated
    private RepairErrorCodeListDTO mappedTo;

    /**
     * Default constructor
     */
    @Generated
    public RepairErrorCodeCreateDTO() {
    }
     ...
     */
    @Generated
    public RepairErrorCodeCreateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairErrorCodeCreateDTO(String name, String code) {
        this.name = name;
        this.code = code;
    }
     ...
     */
    @Generated
    public RepairErrorCodeCreateDTO(String name, String groupName, String code, String shortText, String comment, boolean active,
     ...
     */
    @Generated
    public RepairErrorCodeListDTO getMappedTo() {
     ...
     */
    @Generated
    public void setMappedTo(RepairErrorCodeListDTO mappedTo) {
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (RepairErrorCodeCreateDTO) obj;
