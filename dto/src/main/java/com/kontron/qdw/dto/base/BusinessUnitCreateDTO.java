...
public class BusinessUnitCreateDTO implements Serializable {
    @Generated
     ...
     */
    @Generated
    public BusinessUnitCreateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public BusinessUnitCreateDTO(String code, String shortText, String comment, boolean active, LocalDateTime creationDate, int version) {
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (BusinessUnitCreateDTO) obj;
