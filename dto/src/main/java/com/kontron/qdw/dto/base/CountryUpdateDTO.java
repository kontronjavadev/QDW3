...
public class CountryUpdateDTO implements Serializable {
     ...
     */
    @Generated
    public CountryUpdateDTO(String code) {
        this.code = code;
    }
     ...
     */
    @Generated
    public CountryUpdateDTO(String name, String code) {
        this.name = name;
        this.code = code;
    }
     ...
     */
    @Generated
    public CountryUpdateDTO(String name, String code, String shortText, String comment, boolean active, LocalDateTime creationDate,
    ...
    public boolean equals(Object obj) {
        ...
        final var dto = (CountryUpdateDTO) obj;
