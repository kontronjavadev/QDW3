...
public class EditBusinessUnitDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditBusinessUnitDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANBUSINESSUNIT = "form:tabview1:tabPanBusinessUnit";
     ...
     */
    @Generated
    public EditBusinessUnitDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
