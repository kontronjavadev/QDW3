...
public class ViewMaterialDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewMaterialDialog.jsf";
    @Generated
     ...
     */
    @Generated
    public ViewMaterialDialog(SeleniumTestContext testContext) {
        super(testContext);
