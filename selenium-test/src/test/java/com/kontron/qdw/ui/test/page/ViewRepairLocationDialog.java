...
public class ViewRepairLocationDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewRepairLocationDialog.jsf";
    @Generated
     ...
     */
    @Generated
    public ViewRepairLocationDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
