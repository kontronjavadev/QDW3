...
public class ViewFaultAnalysisDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewFaultAnalysisDialog.jsf";
    @Generated
     ...
     */
    @Generated
    public ViewFaultAnalysisDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
