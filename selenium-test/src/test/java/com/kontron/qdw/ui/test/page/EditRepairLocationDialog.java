...
public class EditRepairLocationDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditRepairLocationDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANREPAIRLOCATION = "form:tabview1:tabPanRepairLocation";
     ...
     */
    @Generated
    public EditRepairLocationDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
