...
public class ViewSupplierDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewSupplierDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANSUPPLIER = "form:tabview1:tabPanSupplier";
     ...
     */
    @Generated
    public ViewSupplierDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
