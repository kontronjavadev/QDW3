...
public class EditMovementTypeDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditMovementTypeDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANMOVEMENTTYPE = "form:tabview1:tabPanMovementType";
    @Generated
     ...
     */
    @Generated
    public EditMovementTypeDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
