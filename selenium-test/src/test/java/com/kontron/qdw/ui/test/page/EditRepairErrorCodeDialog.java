...
public class EditRepairErrorCodeDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditRepairErrorCodeDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String FIELD_ID_TXTGROUPNAME = "form:tabview1:txtGroupName";
    @Generated
    public static final String FIELD_ID_CBOMAPPEDTO = "form:tabview1:cboMappedTo_input";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANREPAIRERRORCODE = "form:tabview1:tabPanRepairErrorCode";
     ...
     */
    @Generated
    public EditRepairErrorCodeDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
