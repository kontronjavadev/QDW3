...
public class EditLocationDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditLocationDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANLOCATION = "form:tabview1:tabPanLocation";
    @Generated
     ...
     */
    @Generated
    public EditLocationDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
