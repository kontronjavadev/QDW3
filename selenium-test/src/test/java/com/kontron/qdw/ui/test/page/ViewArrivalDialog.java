...
public class ViewArrivalDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewArrivalDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANARRIVAL = "form:tabview1:tabPanArrival";
    @Generated
     ...
     */
    @Generated
    public ViewArrivalDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
