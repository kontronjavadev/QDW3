...
public class EditRepairTaskDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditRepairTaskDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANREPAIRTASK = "form:tabview1:tabPanRepairTask";
     ...
     */
    @Generated
    public EditRepairTaskDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
