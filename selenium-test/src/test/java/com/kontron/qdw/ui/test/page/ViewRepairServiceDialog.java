...
public class ViewRepairServiceDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewRepairServiceDialog.jsf";
    @Generated
     ...
     */
    @Generated
    public ViewRepairServiceDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
