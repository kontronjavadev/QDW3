...
public class EditRMATypeDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditRMATypeDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANRMATYPE = "form:tabview1:tabPanRMAType";
     ...
     */
    @Generated
    public EditRMATypeDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
