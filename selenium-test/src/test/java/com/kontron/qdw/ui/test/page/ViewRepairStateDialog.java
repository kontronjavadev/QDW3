...
public class ViewRepairStateDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewRepairStateDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANREPAIRSTATE = "form:tabview1:tabPanRepairState";
     ...
     */
    @Generated
    public ViewRepairStateDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
