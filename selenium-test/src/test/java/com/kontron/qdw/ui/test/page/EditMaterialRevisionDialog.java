...
public class EditMaterialRevisionDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditMaterialRevisionDialog.jsf";
    @Generated
     ...
     */
    @Generated
    public EditMaterialRevisionDialog(SeleniumTestContext testContext) {
        super(testContext);
