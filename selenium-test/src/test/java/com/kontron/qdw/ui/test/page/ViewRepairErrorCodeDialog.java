...
public class ViewRepairErrorCodeDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewRepairErrorCodeDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String FIELD_ID_CBOMAPPEDTO = "form:tabview1:cboMappedTo";
    @Generated
     ...
     */
    @Generated
    public ViewRepairErrorCodeDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
