...
public class EditRepairServiceDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditRepairServiceDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANREPAIRSERVICE = "form:tabview1:tabPanRepairService";
     ...
     */
    @Generated
    public EditRepairServiceDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
