...
public class EditMaterialTypeDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditMaterialTypeDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANMATERIALTYPE = "form:tabview1:tabPanMaterialType";
    @Generated
     ...
     */
    @Generated
    public EditMaterialTypeDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
