...
public class ViewCustomerDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewCustomerDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String FIELD_ID_CBOCOUNTRY = "form:tabview1:cboCountry";
    @Generated
     ...
     */
    @Generated
    public ViewCustomerDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
