...
public class ViewRMATypeDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewRMATypeDialog.jsf";
    @Generated
     ...
     */
    @Generated
    public ViewRMATypeDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
