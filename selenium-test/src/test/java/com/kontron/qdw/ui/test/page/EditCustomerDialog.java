...
public class EditCustomerDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditCustomerDialog.jsf";
    @Generated
    public static final String FIELD_ID_TXTCODE = "form:tabview1:txtCode";
    @Generated
    public static final String FIELD_ID_CHKINTERNAL = "form:tabview1:chkInternal";
    @Generated
    ...
    @Generated
    public static final String FIELD_ID_CBOVERTICALSECTOR = "form:tabview1:cboVerticalSector";
    @Generated
    public static final String FIELD_ID_TXTSTREET = "form:tabview1:txtStreet";
    @Generated
    public static final String FIELD_ID_TXTZIPCODE = "form:tabview1:txtZipCode";
    @Generated
    public static final String FIELD_ID_TXTCITY = "form:tabview1:txtCity";
    @Generated
    public static final String FIELD_ID_CBOCOUNTRY = "form:tabview1:cboCountry_input";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANCUSTOMER = "form:tabview1:tabPanCustomer";
     ...
     */
    @Generated
    public EditCustomerDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
