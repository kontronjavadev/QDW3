...
public class EditFaultAnalysisDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/EditFaultAnalysisDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANFAULTANALYSIS = "form:tabview1:tabPanFaultAnalysis";
     ...
     */
    @Generated
    public EditFaultAnalysisDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
