...
public class ViewBoMItemDialog extends AbstractPageObject {
    @Generated
    public static final String RESOURCE_PATH = "/dialog/ViewBoMItemDialog.jsf";
    @Generated
    ...
    @Generated
    public static final String TAB_PAGE_PANBOMITEM = "form:tabview1:tabPanBoMItem";
     ...
     */
    @Generated
    public ViewBoMItemDialog(SeleniumTestContext testContext) {
        super(testContext);
    }
