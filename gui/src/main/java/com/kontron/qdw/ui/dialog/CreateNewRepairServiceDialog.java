...
@Named("createNewRepairServiceDialog")
@ViewScoped
public class CreateNewRepairServiceDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/CreateNewRepairServiceDialog.jsf?faces-redirect=true";
    @Generated
    private RepairServiceCreateDTO repairService;
    @Generated
     ...
     */
    @Generated
    public CreateNewRepairServiceDialog() {
    ...
    @Inject
    @Generated
    public CreateNewRepairServiceDialog(RepairServiceBoundaryService repairServiceService, UserSession userSession) {
     ...
     */
    @Generated
    public RepairServiceCreateDTO getRepairService() {
     ...
     */
    @Generated
    public void setRepairService(RepairServiceCreateDTO repairService) {
    ...
    public void initView() {
        ...
        try {
            repairService = new RepairServiceCreateDTO();

            formTitle = bundle.getString(FORM_CREATENEWREPAIRSERVICEDIALOG_TITLE);
    ...
    public String save() {
        try {
            ...
            repairServiceService.createRepairService(repairService);
    ...
    public String getCurrentPageURL() {
        return CreateNewRepairServiceDialog.PAGE_INIT_URL;
    }
