...
@Named("editRepairTaskDialog")
@ViewScoped
public class EditRepairTaskDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditRepairTaskDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private RepairTaskUpdateDTO repairTask;
    @Generated
    ...
    @Inject
    @Generated
    public EditRepairTaskDialog(RepairTaskBoundaryService repairTaskService, UserSession userSession) {
     ...
     */
    @Generated
    public RepairTaskUpdateDTO getRepairTask() {
        return repairTask;
    }
     ...
     */
    @Generated
    public void setRepairTask(RepairTaskUpdateDTO repairTask) {
    ...
    public void initView() {
        ...
        try {
            ...
            repairTask = repairTaskService.getRepairTaskForUpdate(selectedObjectId);

            formTitle = bundle.getString(FORM_EDITREPAIRTASKDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String getCurrentPageURL() {
        return EditRepairTaskDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
