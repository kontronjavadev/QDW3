...
@Named("serviceOrderListDTOConverter")
@RequestScoped
public class ServiceOrderListDTOConverter implements Converter<ServiceOrderListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public ServiceOrderListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new ServiceOrderListDTO(submittedValue);
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, ServiceOrderListDTO value) {
        if (value == null)
            return null;
