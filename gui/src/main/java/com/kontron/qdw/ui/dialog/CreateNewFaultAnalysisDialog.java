...
@Named("createNewFaultAnalysisDialog")
@ViewScoped
public class CreateNewFaultAnalysisDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/CreateNewFaultAnalysisDialog.jsf?faces-redirect=true";
    @Generated
    private FaultAnalysisCreateDTO faultAnalysis;
    @Generated
     ...
     */
    @Generated
    public CreateNewFaultAnalysisDialog() {
    ...
    @Inject
    @Generated
    public CreateNewFaultAnalysisDialog(FaultAnalysisBoundaryService faultAnalysisService, UserSession userSession) {
     ...
     */
    @Generated
    public FaultAnalysisCreateDTO getFaultAnalysis() {
     ...
     */
    @Generated
    public void setFaultAnalysis(FaultAnalysisCreateDTO faultAnalysis) {
    ...
    public void initView() {
        ...
        try {
            faultAnalysis = new FaultAnalysisCreateDTO();

            formTitle = bundle.getString(FORM_CREATENEWFAULTANALYSISDIALOG_TITLE);
    ...
    public String save() {
        try {
            ...
            faultAnalysisService.createFaultAnalysis(faultAnalysis);
    ...
    public String getCurrentPageURL() {
        return CreateNewFaultAnalysisDialog.PAGE_INIT_URL;
    }
