...
@Named("rMATypeListDTOConverter")
@RequestScoped
public class RMATypeListDTOConverter implements Converter<RMATypeListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public RMATypeListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new RMATypeListDTO(submittedValue);
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, RMATypeListDTO value) {
        if (value == null)
            return null;
