...
@Named("editMaterialClassDialog")
@ViewScoped
public class EditMaterialClassDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditMaterialClassDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private MaterialClassUpdateDTO materialClass;
    @Generated
     ...
     */
    @Generated
    public EditMaterialClassDialog() {
    ...
    @Inject
    @Generated
    public EditMaterialClassDialog(MaterialClassBoundaryService materialClassService, UserSession userSession) {
     ...
     */
    @Generated
    public MaterialClassUpdateDTO getMaterialClass() {
     ...
     */
    @Generated
    public void setMaterialClass(MaterialClassUpdateDTO materialClass) {
    ...
    public void initView() {
        ...
        try {
            ...
            materialClass = materialClassService.getMaterialClassForUpdate(selectedObjectId);

            formTitle = bundle.getString(FORM_EDITMATERIALCLASSDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String save() {
        try {
            ...
            materialClassService.updateMaterialClass(materialClass);
    ...
    public String getCurrentPageURL() {
        return EditMaterialClassDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
