...
@Named("locationListDTOConverter")
@RequestScoped
public class LocationListDTOConverter implements Converter<LocationListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public LocationListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new LocationListDTO(submittedValue);
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, LocationListDTO value) {
        if (value == null)
            return null;
