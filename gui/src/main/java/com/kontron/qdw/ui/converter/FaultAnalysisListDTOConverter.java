...
@Named("faultAnalysisListDTOConverter")
@RequestScoped
public class FaultAnalysisListDTOConverter implements Converter<FaultAnalysisListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public FaultAnalysisListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new FaultAnalysisListDTO(submittedValue);
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, FaultAnalysisListDTO value) {
        if (value == null)
            return null;
