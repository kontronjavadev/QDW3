...
@ViewScoped
public class AggregatedShipmentArrivalView extends AbstractSearchableView implements Serializable {
    @Generated
    ...
    public void initSearchObject() {
        ...
        final var f11 = new JSFSearchFieldDTO(searchObj, ++colOrderId, AggregatedShipmentArrivalSearchDTO.SELECT_MATREVMATOWNERLOCATIONCODE,
        ...
        final var f12 = new JSFSearchFieldDTO(searchObj, ++colOrderId, AggregatedShipmentArrivalSearchDTO.SELECT_MATREVMATMATERIALTYPECODE,
        ...
        final var f13 = new JSFSearchFieldDTO(searchObj, ++colOrderId, AggregatedShipmentArrivalSearchDTO.SELECT_MATREVMATMATERIALCLASSCODE,
        ...
        final var f14 = new JSFSearchFieldDTO(searchObj, ++colOrderId, AggregatedShipmentArrivalSearchDTO.SELECT_MATERIALREVISIONREVISIONNUMBER,
        ...
        final var f15 = new JSFSearchFieldDTO(searchObj, ++colOrderId, AggregatedShipmentArrivalSearchDTO.SELECT_YEAR,
                bundle.getString(LBL_ATTR_ABSTRACTAGGREGATEDBASE_YEAR), SearchFieldDataTypeEnum.INTEGER, 80);
        f15.setVisible(false);


        final var f16 = new JSFSearchFieldDTO(searchObj, ++colOrderId, AggregatedShipmentArrivalSearchDTO.SELECT_MONTH,
                bundle.getString(LBL_ATTR_ABSTRACTAGGREGATEDBASE_MONTH), SearchFieldDataTypeEnum.INTEGER, 80);
        f16.setVisible(false);


        final var f17 = new JSFSearchFieldDTO(searchObj, ++colOrderId, AggregatedShipmentArrivalSearchDTO.SELECT_SHIPMENTS,
