...
@Named("createNewPlantDialog")
@ViewScoped
public class CreateNewPlantDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/CreateNewPlantDialog.jsf?faces-redirect=true";
    @Generated
    private PlantCreateDTO plant;
    @Generated
    ...
    @Inject
    @Generated
    public CreateNewPlantDialog(PlantBoundaryService plantService, UserSession userSession) {
     ...
     */
    @Generated
    public PlantCreateDTO getPlant() {
        return plant;
    }
     ...
     */
    @Generated
    public void setPlant(PlantCreateDTO plant) {
        this.plant = plant;
    }
    ...
    public void initView() {
        ...
        try {
            plant = new PlantCreateDTO();
            plant.setActive(true);

            formTitle = bundle.getString(FORM_CREATENEWPLANTDIALOG_TITLE);
    ...
    public String getCurrentPageURL() {
        return CreateNewPlantDialog.PAGE_INIT_URL;
    }
