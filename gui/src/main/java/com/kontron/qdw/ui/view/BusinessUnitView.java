...
public class BusinessUnitView extends CopyClipboard implements Serializable {
    ...
    @Generated
    private List<BusinessUnitSearchDTO> businessUnitsList = new ArrayList<>();
    @Generated
    private BusinessUnitSearchDTO selectedObject;
    @Generated
    ...
    @Generated
    public static final String PAGE_URL = "/view/BusinessUnitView.jsf?faces-redirect=true";
    @Generated
    ...
    @Inject
    @Generated
    public BusinessUnitView(UserSession userSession, BusinessUnitBoundaryService businessUnitService) {
     ...
     */
    @Generated
    public Collection<BusinessUnitSearchDTO> getBusinessUnitsList() {
     ...
     */
    @Generated
    public BusinessUnitSearchDTO getSelectedObject() {
     ...
     */
    @Generated
    public void setSelectedObject(BusinessUnitSearchDTO selectedObject) {
    ...
    public void onDoubleClick() {
        ...
        userSession.redirectTo(getCurrentPageURL(), openEditBusinessUnitDialog());
    }
    ...
    public void deleteBusinessUnit() {
        try {
            ...
            businessUnitService.deleteBusinessUnit(selectedObject.getCode());
        }
    ...
    public String copy() {
        ...
        try {
            ...
            newId = businessUnitService.copy(selectedObject.getCode(), userSession.getPrincipal().getId());
        }
        catch (final Exception e) {
        ...
        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = EditBusinessUnitDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(newId, java.nio.charset.StandardCharsets.UTF_8);
     ...
     */
    @Generated
    public String openEditBusinessUnitDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = EditBusinessUnitDialog.PAGE_INIT_URL
     ...
     */
    @Generated
    public String openCreateNewBusinessUnitDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = CreateNewBusinessUnitDialog.PAGE_INIT_URL;
    ...
    public void initSearchObject() {
        ...
        final var field1 = new SearchFieldDTO(++colOrderId, BusinessUnitSearchDTO.SELECT_CODE,
        ...
        final var field2 = new SearchFieldDTO(++colOrderId, BusinessUnitSearchDTO.SELECT_SHORTTEXT,
        ...
        final var field3 = new SearchFieldDTO(++colOrderId, BusinessUnitSearchDTO.SELECT_COMMENT,
        ...
        final var field4 = new SearchFieldDTO(++colOrderId, BusinessUnitSearchDTO.SELECT_ACTIVE,
        ...
        final var field5 = new SearchFieldDTO(++colOrderId, BusinessUnitSearchDTO.SELECT_CREATIONDATE,
        ...
        final var field6 = new SearchFieldDTO(++colOrderId, BusinessUnitSearchDTO.SELECT_LASTUPDATE,
        ...
        try {
            businessUnitsList = businessUnitService.searchAllBusinessUnits(searchObj);
        }
        catch (final Exception e) {
    ...
    public void fetchBusinessUnits() {
        ...
        formTitle = bundle.getString(FORM_BUSINESSUNITVIEW_TITLE);
