...
@Named("plantListDTOConverter")
@RequestScoped
public class PlantListDTOConverter implements Converter<PlantListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public PlantListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new PlantListDTO(submittedValue);
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, PlantListDTO value) {
        if (value == null)
            return null;
