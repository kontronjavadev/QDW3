...
@Named("countryView")
@ViewScoped
public class CountryView extends CopyClipboard implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    private List<CountrySearchDTO> countriesList = new ArrayList<>();
    @Generated
    private CountrySearchDTO selectedObject;
    @Generated
    ...
    @Generated
    public static final String PAGE_URL = "/view/CountryView.jsf?faces-redirect=true";
    @Generated
    ...
    @Inject
    @Generated
    public CountryView(UserSession userSession, CountryBoundaryService countryService) {
     ...
     */
    @Generated
    public Collection<CountrySearchDTO> getCountriesList() {
     ...
     */
    @Generated
    public CountrySearchDTO getSelectedObject() {
     ...
     */
    @Generated
    public void setSelectedObject(CountrySearchDTO selectedObject) {
    ...
    public void onDoubleClick() {
        ...
        userSession.redirectTo(getCurrentPageURL(), openEditCountryDialog());
    }
    ...
    public void deleteCountry() {
        try {
            ...
            countryService.deleteCountry(selectedObject.getCode());
        }
    ...
    public String copy() {
        ...
        try {
            ...
            newId = countryService.copy(selectedObject.getCode(), userSession.getPrincipal().getId());
        }
        catch (final Exception e) {
        ...
        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = EditCountryDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(newId, java.nio.charset.StandardCharsets.UTF_8);
     ...
     */
    @Generated
    public String openCreateNewCountryDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = CreateNewCountryDialog.PAGE_INIT_URL;
     ...
     */
    @Generated
    public String openEditCountryDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = EditCountryDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObject.getCode(), java.nio.charset.StandardCharsets.UTF_8);
    ...
    public void initSearchObject() {
        ...
        final var field1 = new SearchFieldDTO(++colOrderId, CountrySearchDTO.SELECT_NAME, bundle.getString(LBL_ATTR_COUNTRY_NAME),
                SearchFieldDataTypeEnum.STRING, 150);
        searchObj.getSearchFields().add(field1);


        final var field2 = new SearchFieldDTO(++colOrderId, CountrySearchDTO.SELECT_CODE,
                bundle.getString(LBL_ATTR_ABSTRACTFUNCTIONALACTIVEENTITY_CODE), SearchFieldDataTypeEnum.STRING, 50);
        searchObj.getSearchFields().add(field2);


        final var field3 = new SearchFieldDTO(++colOrderId, CountrySearchDTO.SELECT_ACTIVE,
        ...
        final var field4 = new SearchFieldDTO(++colOrderId, CountrySearchDTO.SELECT_SHORTTEXT,
        ...
        final var field5 = new SearchFieldDTO(++colOrderId, CountrySearchDTO.SELECT_COMMENT,
        ...
        final var field6 = new SearchFieldDTO(++colOrderId, CountrySearchDTO.SELECT_CREATIONDATE,
        ...
        final var field7 = new SearchFieldDTO(++colOrderId, CountrySearchDTO.SELECT_LASTUPDATE,
        ...
        try {
            countriesList = countryService.searchAllCountries(searchObj);
        }
        catch (final Exception e) {
    ...
    public void fetchCountries() {
        ...
        formTitle = bundle.getString(FORM_COUNTRYVIEW_TITLE);
