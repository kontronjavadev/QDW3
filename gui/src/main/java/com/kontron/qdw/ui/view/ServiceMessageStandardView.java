...
@ViewScoped
public class ServiceMessageStandardView extends SuperView implements Serializable {
    @Generated
    ...
    public void initSearchObject() {
        ...
        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_ID,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_ID), SearchFieldDataTypeEnum.LONG, 120);
        ...
        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_MATREVMATMATERIALTYPECODE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_MATREVMATMATERIALTYPECODE), SearchFieldDataTypeEnum.STRING, 80);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_MATREVMATMATERIALCLASSCODE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_MATREVMATMATERIALCLASSCODE), SearchFieldDataTypeEnum.STRING, 100);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_MATREVREVISIONNUMBER,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_MATREVREVISIONNUMBER), SearchFieldDataTypeEnum.STRING, 150);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_SERVICEORDERCOMMENT,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_SERVICEORDERCOMMENT), SearchFieldDataTypeEnum.STRING, 250);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_REPAIRSTATENAME,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_REPAIRSTATENAME), SearchFieldDataTypeEnum.STRING, 120);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_REPAIRERRORCODEGROUPNAME,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_REPAIRERRORCODEGROUPNAME), SearchFieldDataTypeEnum.STRING, 150);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_REPAIRERRORCODENAME,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_REPAIRERRORCODENAME), SearchFieldDataTypeEnum.STRING, 150);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_REPAIRERRORCODESHORTTEXT,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_REPAIRERRORCODESHORTTEXT), SearchFieldDataTypeEnum.STRING, 250);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_REPAIRLOCATIONCODE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_REPAIRLOCATIONCODE), SearchFieldDataTypeEnum.STRING, 100);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_RMATYPECODE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_RMATYPECODE), SearchFieldDataTypeEnum.STRING, 100);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_REPAIRSERVICENAME,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_REPAIRSERVICENAME), SearchFieldDataTypeEnum.STRING, 100);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_FAULTANALYSISCODE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_FAULTANALYSISCODE), SearchFieldDataTypeEnum.STRING, 120);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_FAULTANALYSISSHORTTEXT,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_FAULTANALYSISSHORTTEXT), SearchFieldDataTypeEnum.STRING, 250);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_REPAIRTASKCODE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_REPAIRTASKCODE), SearchFieldDataTypeEnum.STRING, 120);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_REPAIRTASKSHORTTEXT,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_REPAIRTASKSHORTTEXT), SearchFieldDataTypeEnum.STRING, 250);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_EXTERNALSUPPLIERNAME,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_EXTERNALSUPPLIERNAME), SearchFieldDataTypeEnum.STRING, 200);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_ERRORID,
                bundle.getString(LBL_ATTR_SERVICEMESSAGE_ERRORID), SearchFieldDataTypeEnum.STRING, 100);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_ORIGIN,
                bundle.getString(LBL_ATTR_SERVICEMESSAGE_ORIGIN), SearchFieldDataTypeEnum.STRING, 150);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_DESIGNATOR,
                bundle.getString(LBL_ATTR_SERVICEMESSAGE_DESIGNATOR), SearchFieldDataTypeEnum.STRING, 100);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_DEFECTCOMPONENT,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_DEFECTCOMPONENT), SearchFieldDataTypeEnum.STRING, 120);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_INTERNALREPORT,
                bundle.getString(LBL_ATTR_SERVICEMESSAGE_INTERNALREPORT), SearchFieldDataTypeEnum.STRING, 250);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_EXTERNALREPORT,
                bundle.getString(LBL_ATTR_SERVICEMESSAGE_EXTERNALREPORT), SearchFieldDataTypeEnum.STRING, 250);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_CUSTOMERREPORT,
                bundle.getString(LBL_ATTR_SERVICEMESSAGE_CUSTOMERREPORT), SearchFieldDataTypeEnum.STRING, 250);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_CUSTOMERFAILURE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_CUSTOMERFAILURE), SearchFieldDataTypeEnum.BOOLEAN, 80);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_BASICSTARTDATE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_BASICSTARTDATE), SearchFieldDataTypeEnum.LOCAL_DATE, 100, false);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_BASICFINISHDATE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_BASICFINISHDATE), SearchFieldDataTypeEnum.LOCAL_DATE, 100, false);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_INTERNALARRIVALDATE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_INTERNALARRIVALDATE), SearchFieldDataTypeEnum.LOCAL_DATE, 110, false);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_INTERNALSHIPMENTDATE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_INTERNALSHIPMENTDATE), SearchFieldDataTypeEnum.LOCAL_DATE, 110, false);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_EPIDEMICFAILURE,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_EPIDEMICFAILURE), SearchFieldDataTypeEnum.BOOLEAN, 80);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_ANALYSISTEXT,
                bundle.getString(LBL_ATTR_SERVICEMESSAGE_ANALYSISTEXT), SearchFieldDataTypeEnum.STRING, 250);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_DELIVERYNOTENUMBER,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_DELIVERYNOTENUMBER), SearchFieldDataTypeEnum.STRING, 100);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_SERVICEMESSAGEID,
                bundle.getString(COL_SERVICEMESSAGESTANDARDVIEW_SERVICEMESSAGEID), SearchFieldDataTypeEnum.STRING, 100);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_CAUSETEXT,
                bundle.getString(LBL_ATTR_SERVICEMESSAGE_CAUSETEXT), SearchFieldDataTypeEnum.STRING, 250);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_REPAIRDESCRIPTION,
                bundle.getString(LBL_ATTR_SERVICEMESSAGE_REPAIRDESCRIPTION), SearchFieldDataTypeEnum.STRING, 250);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_CREATIONDATE,
                bundle.getString(LBL_ATTR_ABSTRACTENTITYWITHID_CREATIONDATE), SearchFieldDataTypeEnum.LOCAL_DATE_TIME, 120);

        new JSFSearchFieldDTO(searchObj, ++colOrderId, ServiceMessageStandardSearchDTO.SELECT_LASTUPDATE,
