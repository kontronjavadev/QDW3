...
@Named("editRepairServiceDialog")
@ViewScoped
public class EditRepairServiceDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditRepairServiceDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private RepairServiceUpdateDTO repairService;
    @Generated
     ...
     */
    @Generated
    public EditRepairServiceDialog() {
    ...
    @Inject
    @Generated
    public EditRepairServiceDialog(RepairServiceBoundaryService repairServiceService, UserSession userSession) {
     ...
     */
    @Generated
    public RepairServiceUpdateDTO getRepairService() {
     ...
     */
    @Generated
    public void setRepairService(RepairServiceUpdateDTO repairService) {
    ...
    public void initView() {
        ...
        try {
            ...
            repairService = repairServiceService.getRepairServiceForUpdate(selectedObjectId);

            formTitle = bundle.getString(FORM_EDITREPAIRSERVICEDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String save() {
        try {
            ...
            repairServiceService.updateRepairService(repairService);
    ...
    public String getCurrentPageURL() {
        return EditRepairServiceDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
