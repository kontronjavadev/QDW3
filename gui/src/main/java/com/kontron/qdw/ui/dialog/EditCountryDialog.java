...
@Named("editCountryDialog")
@ViewScoped
public class EditCountryDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditCountryDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private CountryUpdateDTO country;
    @Generated
    ...
    @Inject
    @Generated
    public EditCountryDialog(CountryBoundaryService countryService, UserSession userSession) {
     ...
     */
    @Generated
    public CountryUpdateDTO getCountry() {
        return country;
    }
     ...
     */
    @Generated
    public void setCountry(CountryUpdateDTO country) {
    ...
    public void initView() {
        ...
        try {
            ...
            country = countryService.getCountryForUpdate(selectedObjectId);

            formTitle = bundle.getString(FORM_EDITCOUNTRYDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String getCurrentPageURL() {
        return EditCountryDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
