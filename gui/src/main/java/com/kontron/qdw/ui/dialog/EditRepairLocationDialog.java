...
@Named("editRepairLocationDialog")
@ViewScoped
public class EditRepairLocationDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditRepairLocationDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private RepairLocationUpdateDTO repairLocation;
    @Generated
     ...
     */
    @Generated
    public EditRepairLocationDialog() {
    ...
    @Inject
    @Generated
    public EditRepairLocationDialog(RepairLocationBoundaryService repairLocationService, UserSession userSession) {
     ...
     */
    @Generated
    public RepairLocationUpdateDTO getRepairLocation() {
     ...
     */
    @Generated
    public void setRepairLocation(RepairLocationUpdateDTO repairLocation) {
    ...
    public void initView() {
        ...
        try {
            ...
            repairLocation = repairLocationService.getRepairLocationForUpdate(selectedObjectId);

            formTitle = bundle.getString(FORM_EDITREPAIRLOCATIONDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String save() {
        try {
            ...
            repairLocationService.updateRepairLocation(repairLocation);
    ...
    public String getCurrentPageURL() {
        return EditRepairLocationDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
