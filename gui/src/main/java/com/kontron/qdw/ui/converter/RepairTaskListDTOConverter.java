...
@Named("repairTaskListDTOConverter")
@RequestScoped
public class RepairTaskListDTOConverter implements Converter<RepairTaskListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public RepairTaskListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new RepairTaskListDTO(submittedValue);
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, RepairTaskListDTO value) {
        if (value == null)
            return null;
