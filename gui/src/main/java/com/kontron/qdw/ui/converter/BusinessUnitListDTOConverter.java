...
@Named("businessUnitListDTOConverter")
@RequestScoped
public class BusinessUnitListDTOConverter implements Converter<BusinessUnitListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public BusinessUnitListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new BusinessUnitListDTO(submittedValue);
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, BusinessUnitListDTO value) {
        if (value == null)
            return null;
