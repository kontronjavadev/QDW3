...
@Named("serviceMessageListDTOConverter")
@RequestScoped
public class ServiceMessageListDTOConverter implements Converter<ServiceMessageListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public ServiceMessageListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new ServiceMessageListDTO(Long.parseLong(submittedValue));
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, ServiceMessageListDTO value) {
        if (value == null)
            return null;
