...
@Named("editEWSEntryDialog")
@ViewScoped
public class EditEWSEntryDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditEWSEntryDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private EWSEntryUpdateDTO eWSEntry;
    @Generated
    ...
    @Inject
    @Generated
    public EditEWSEntryDialog(EWSEntryBoundaryService eWSEntryService, UserSession userSession, MaterialBoundaryService materialService,
     ...
     */
    @Generated
    public EWSEntryUpdateDTO geteWSEntry() {
        return eWSEntry;
    }
     ...
     */
    @Generated
    public void seteWSEntry(EWSEntryUpdateDTO eWSEntry) {
    ...
    public void initView() {
        ...
        try {
            ...
            eWSEntry = eWSEntryService.getEWSEntryForUpdate(selectedObjectId);

            final var receiversSourceList = new ArrayList<UserListDTO>();
            final ArrayList<UserListDTO> receiversTargetList = new ArrayList<>(eWSEntry.getReceivers());

            receiversList = new DualListModel<>(receiversSourceList, receiversTargetList);


            formTitle = bundle.getString(FORM_EDITEWSENTRYDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String save() {
        try {
            ...
            eWSEntryService.updateEWSEntry(eWSEntry);
    ...
    public String getCurrentPageURL() {
        return EditEWSEntryDialog.PAGE_INIT_URL + selectedObjectId;
    }
