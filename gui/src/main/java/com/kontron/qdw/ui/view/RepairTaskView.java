...
@Named("repairTaskView")
@ViewScoped
public class RepairTaskView extends CopyClipboard implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    private List<RepairTaskSearchDTO> repairTasksList = new ArrayList<>();
    @Generated
    private RepairTaskSearchDTO selectedObject;
    @Generated
    ...
    @Generated
    public static final String PAGE_URL = "/view/RepairTaskView.jsf?faces-redirect=true";
    @Generated
    ...
    @Inject
    @Generated
    public RepairTaskView(UserSession userSession, RepairTaskBoundaryService repairTaskService) {
     ...
     */
    @Generated
    public Collection<RepairTaskSearchDTO> getRepairTasksList() {
     ...
     */
    @Generated
    public RepairTaskSearchDTO getSelectedObject() {
     ...
     */
    @Generated
    public void setSelectedObject(RepairTaskSearchDTO selectedObject) {
    ...
    public void onDoubleClick() {
        ...
        userSession.redirectTo(getCurrentPageURL(), openEditRepairTaskDialog());
    }
     ...
     */
    @Generated
    public void deleteRepairTask() {
        try {
            logger.debug("Delete selected object with id '{}'", selectedObject.getCode());

            repairTaskService.deleteRepairTask(selectedObject.getCode());
        }
    ...
    public String copy() {
        ...
        try {
            ...
            newId = repairTaskService.copy(selectedObject.getCode(), userSession.getPrincipal().getId());
        }
        catch (final Exception e) {
        ...
        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = EditRepairTaskDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(newId, java.nio.charset.StandardCharsets.UTF_8);
        }
     ...
     */
    @Generated
    public String openCreateNewRepairTaskDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = CreateNewRepairTaskDialog.PAGE_INIT_URL;
        }
     ...
     */
    @Generated
    public String openEditRepairTaskDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = EditRepairTaskDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObject.getCode(), java.nio.charset.StandardCharsets.UTF_8);
        }
     ...
     */
    @Generated
    public String openViewRepairTaskDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = ViewRepairTaskDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObject.getCode(), java.nio.charset.StandardCharsets.UTF_8);
        }
    ...
    public void initSearchObject() {
        ...
        final var field1 = new SearchFieldDTO(++colOrderId, RepairTaskSearchDTO.SELECT_CODE, bundle.getString(LBL_ATTR_ABSTRACTFUNTIONALENTITY_CODE),
                SearchFieldDataTypeEnum.STRING, 100);
        searchObj.getSearchFields().add(field1);


        final var field2 = new SearchFieldDTO(++colOrderId, RepairTaskSearchDTO.SELECT_SHORTTEXT,
        ...
        final var field3 = new SearchFieldDTO(++colOrderId, RepairTaskSearchDTO.SELECT_COMMENT,
        ...
        final var field4 = new SearchFieldDTO(++colOrderId, RepairTaskSearchDTO.SELECT_CREATIONDATE,
        ...
        final var field5 = new SearchFieldDTO(++colOrderId, RepairTaskSearchDTO.SELECT_LASTUPDATE,
        ...
        try {
            repairTasksList = repairTaskService.searchAllRepairTasks(searchObj);
        }
        catch (final Exception e) {
    ...
    public void fetchRepairTasks() {
        ...
        formTitle = bundle.getString(FORM_REPAIRTASKVIEW_TITLE);
