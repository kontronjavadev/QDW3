...
@Named("serialObjectServiceMessagesPanel")
@ViewScoped
public class SerialObjectServiceMessagesPanel extends CopyClipboard implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    private List<SerialObjectServiceMessagesDTO> serviceMessagesList = new ArrayList<>();
    @Generated
    private SerialObjectServiceMessagesDTO selItemOfServiceMessages;
    @Generated
     ...
     */
    @Generated
    public SerialObjectServiceMessagesPanel() {
    ...
    @Inject
    @Generated
    public SerialObjectServiceMessagesPanel(UserSession userSession, SerialObjectBoundaryService serialObjectService,
     ...
     */
    @Generated
    public Collection<SerialObjectServiceMessagesDTO> getServiceMessagesList() {
     ...
     */
    @Generated
    public SerialObjectServiceMessagesDTO getSelItemOfServiceMessages() {
     ...
     */
    @Generated
    public void setSelItemOfServiceMessages(SerialObjectServiceMessagesDTO selItemOfServiceMessages) {
    ...
    public void fetchServiceMessages() {
        ...
        try {
            serviceMessagesList = new ArrayList<>(serialObjectService.getServiceMessagesOfSerialObject(selectedObjectId));
        }
        catch (final Exception e) {
