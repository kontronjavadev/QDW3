...
@Named("createNewRoleDialog")
@ViewScoped
public class CreateNewRoleDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/CreateNewRoleDialog.jsf?faces-redirect=true";
    @Generated
    ...
    @Inject
    @Generated
    public CreateNewRoleDialog(RoleBoundaryService roleService, UserSession userSession) {
     ...
     */
    @Generated
    public void setRole(RoleCreateDTO role) {
        this.role = role;
    }
    ...
    public void initView() {
        ...
        try {
            ...
            formTitle = bundle.getString(FORM_CREATENEWROLEDIALOG_TITLE);
    ...
    public String getCurrentPageURL() {
        return CreateNewRoleDialog.PAGE_INIT_URL;
    }
