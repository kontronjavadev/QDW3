...
@Named("editBusinessUnitDialog")
@ViewScoped
public class EditBusinessUnitDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditBusinessUnitDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private BusinessUnitUpdateDTO businessUnit;
    @Generated
    ...
    @Inject
    @Generated
    public EditBusinessUnitDialog(BusinessUnitBoundaryService businessUnitService, UserSession userSession) {
     ...
     */
    @Generated
    public BusinessUnitUpdateDTO getBusinessUnit() {
        return businessUnit;
    }
     ...
     */
    @Generated
    public void setBusinessUnit(BusinessUnitUpdateDTO businessUnit) {
    ...
    public void initView() {
        ...
        try {
            ...
            businessUnit = businessUnitService.getBusinessUnitForUpdate(selectedObjectId);

            formTitle = bundle.getString(FORM_EDITBUSINESSUNITDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String getCurrentPageURL() {
        return EditBusinessUnitDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
