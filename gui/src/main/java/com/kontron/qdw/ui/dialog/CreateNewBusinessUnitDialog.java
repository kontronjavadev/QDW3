...
@Named("createNewBusinessUnitDialog")
@ViewScoped
public class CreateNewBusinessUnitDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/CreateNewBusinessUnitDialog.jsf?faces-redirect=true";
    @Generated
    private BusinessUnitCreateDTO businessUnit;
    @Generated
     ...
     */
    @Generated
    public CreateNewBusinessUnitDialog() {
    ...
    @Inject
    @Generated
    public CreateNewBusinessUnitDialog(BusinessUnitBoundaryService businessUnitService, UserSession userSession) {
     ...
     */
    @Generated
    public BusinessUnitCreateDTO getBusinessUnit() {
        return businessUnit;
    }
     ...
     */
    @Generated
    public void setBusinessUnit(BusinessUnitCreateDTO businessUnit) {
    ...
    public void initView() {
        ...
        try {
            businessUnit = new BusinessUnitCreateDTO();
            businessUnit.setActive(true);

            formTitle = bundle.getString(FORM_CREATENEWBUSINESSUNITDIALOG_TITLE);
    ...
    public String getCurrentPageURL() {
        return CreateNewBusinessUnitDialog.PAGE_INIT_URL;
    }
