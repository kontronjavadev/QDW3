...
@Named("traceBoMListDTOConverter")
@RequestScoped
public class TraceBoMListDTOConverter implements Converter<TraceBoMListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public TraceBoMListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new TraceBoMListDTO(Long.parseLong(submittedValue));
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, TraceBoMListDTO value) {
        if (value == null)
            return null;
