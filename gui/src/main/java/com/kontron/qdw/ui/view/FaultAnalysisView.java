...
@Named("faultAnalysisView")
@ViewScoped
public class FaultAnalysisView extends CopyClipboard implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    private List<FaultAnalysisSearchDTO> faultAnalysesList = new ArrayList<>();
    @Generated
    private FaultAnalysisSearchDTO selectedObject;
    @Generated
    ...
    @Generated
    public static final String PAGE_URL = "/view/FaultAnalysisView.jsf?faces-redirect=true";
    @Generated
    ...
    @Inject
    @Generated
    public FaultAnalysisView(UserSession userSession, FaultAnalysisBoundaryService faultAnalysisService) {
     ...
     */
    @Generated
    public Collection<FaultAnalysisSearchDTO> getFaultAnalysesList() {
        return faultAnalysesList;
    }
     ...
     */
    @Generated
    public FaultAnalysisSearchDTO getSelectedObject() {
     ...
     */
    @Generated
    public void setSelectedObject(FaultAnalysisSearchDTO selectedObject) {
    ...
    public void onDoubleClick() {
        ...
        userSession.redirectTo(getCurrentPageURL(), openEditFaultAnalysisDialog());
    }
     ...
     */
    @Generated
    public void deleteFaultAnalysis() {
        try {
            logger.debug("Delete selected object with id '{}'", selectedObject.getCode());

            faultAnalysisService.deleteFaultAnalysis(selectedObject.getCode());
        }
    ...
    public String copy() {
        ...
        try {
            ...
            newId = faultAnalysisService.copy(selectedObject.getCode(), userSession.getPrincipal().getId());
        }
        catch (final Exception e) {
        ...
        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = EditFaultAnalysisDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(newId, java.nio.charset.StandardCharsets.UTF_8);
        }
     ...
     */
    @Generated
    public String openCreateNewFaultAnalysisDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = CreateNewFaultAnalysisDialog.PAGE_INIT_URL;
        }
     ...
     */
    @Generated
    public String openEditFaultAnalysisDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = EditFaultAnalysisDialog.PAGE_INIT_URL
     ...
     */
    @Generated
    public String openViewFaultAnalysisDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = ViewFaultAnalysisDialog.PAGE_INIT_URL
                    + java.net.URLEncoder.encode(selectedObject.getCode(), java.nio.charset.StandardCharsets.UTF_8);
        }
    ...
    public void initSearchObject() {
        ...
        final var field1 = new SearchFieldDTO(++colOrderId, FaultAnalysisSearchDTO.SELECT_CODE,
                bundle.getString(LBL_ATTR_ABSTRACTFUNTIONALENTITY_CODE), SearchFieldDataTypeEnum.STRING, 150);
        searchObj.getSearchFields().add(field1);


        final var field2 = new SearchFieldDTO(++colOrderId, FaultAnalysisSearchDTO.SELECT_SHORTTEXT,
        ...
        final var field3 = new SearchFieldDTO(++colOrderId, FaultAnalysisSearchDTO.SELECT_COMMENT,
        ...
        final var field4 = new SearchFieldDTO(++colOrderId, FaultAnalysisSearchDTO.SELECT_CREATIONDATE,
        ...
        final var field5 = new SearchFieldDTO(++colOrderId, FaultAnalysisSearchDTO.SELECT_LASTUPDATE,
        ...
        try {
            faultAnalysesList = faultAnalysisService.searchAllFaultAnalyses(searchObj);
        }
        catch (final Exception e) {
     ...
     */
    @Generated
    public void fetchFaultAnalyses() {
        ...
        formTitle = bundle.getString(FORM_FAULTANALYSISVIEW_TITLE);
