...
@Named("createNewMaterialTypeDialog")
@ViewScoped
public class CreateNewMaterialTypeDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/CreateNewMaterialTypeDialog.jsf?faces-redirect=true";
    @Generated
    private MaterialTypeCreateDTO materialType;
    @Generated
     ...
     */
    @Generated
    public CreateNewMaterialTypeDialog() {
    ...
    @Inject
    @Generated
    public CreateNewMaterialTypeDialog(MaterialTypeBoundaryService materialTypeService, UserSession userSession) {
     ...
     */
    @Generated
    public MaterialTypeCreateDTO getMaterialType() {
        return materialType;
    }
     ...
     */
    @Generated
    public void setMaterialType(MaterialTypeCreateDTO materialType) {
    ...
    public void initView() {
        ...
        try {
            materialType = new MaterialTypeCreateDTO();

            formTitle = bundle.getString(FORM_CREATENEWMATERIALTYPEDIALOG_TITLE);
    ...
    public String save() {
        try {
            ...
            materialTypeService.createMaterialType(materialType);
    ...
    public String getCurrentPageURL() {
        return CreateNewMaterialTypeDialog.PAGE_INIT_URL;
    }
