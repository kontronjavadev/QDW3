...
@Named("repairLocationListDTOConverter")
@RequestScoped
public class RepairLocationListDTOConverter implements Converter<RepairLocationListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public RepairLocationListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new RepairLocationListDTO(submittedValue);
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, RepairLocationListDTO value) {
        if (value == null)
            return null;
