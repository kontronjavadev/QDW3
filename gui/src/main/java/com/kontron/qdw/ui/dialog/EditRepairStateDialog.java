...
@Named("editRepairStateDialog")
@ViewScoped
public class EditRepairStateDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditRepairStateDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private RepairStateUpdateDTO repairState;
    @Generated
    ...
    @Inject
    @Generated
    public EditRepairStateDialog(RepairStateBoundaryService repairStateService, UserSession userSession) {
     ...
     */
    @Generated
    public RepairStateUpdateDTO getRepairState() {
        return repairState;
    }
     ...
     */
    @Generated
    public void setRepairState(RepairStateUpdateDTO repairState) {
    ...
    public void initView() {
        ...
        try {
            ...
            repairState = repairStateService.getRepairStateForUpdate(selectedObjectId);

            formTitle = bundle.getString(FORM_EDITREPAIRSTATEDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String getCurrentPageURL() {
        return EditRepairStateDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
