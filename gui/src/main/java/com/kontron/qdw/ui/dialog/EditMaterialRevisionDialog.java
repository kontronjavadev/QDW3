...
@Named("editMaterialRevisionDialog")
@ViewScoped
public class EditMaterialRevisionDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditMaterialRevisionDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private MaterialRevisionUpdateDTO materialRevision;
    @Generated
     ...
     */
    @Generated
    public EditMaterialRevisionDialog() {
    ...
    @Inject
    @Generated
    public EditMaterialRevisionDialog(MaterialRevisionBoundaryService materialRevisionService, UserSession userSession,
     ...
     */
    @Generated
    public MaterialRevisionUpdateDTO getMaterialRevision() {
     ...
     */
    @Generated
    public void setMaterialRevision(MaterialRevisionUpdateDTO materialRevision) {
    ...
    public void initView() {
        ...
        try {
            ...
            materialRevision = materialRevisionService.getMaterialRevisionForUpdate(selectedObjectId);

            panBoMItems.setSelectedObjectId(selectedObjectId);
            panBoMItems.setCurrentPageURL(EditMaterialRevisionDialog.PAGE_INIT_URL + selectedObjectId);
            panBoMItems.setReadOnly(false);
            panBoMItems.initView();


            formTitle = bundle.getString(FORM_EDITMATERIALREVISIONDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String save() {
        try {
            ...
            materialRevisionService.updateMaterialRevision(materialRevision);
