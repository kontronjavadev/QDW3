...
@Named("locationView")
@ViewScoped
public class LocationView extends CopyClipboard implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    private List<LocationSearchDTO> locationsList = new ArrayList<>();
    @Generated
    private LocationSearchDTO selectedObject;
    @Generated
    ...
    @Generated
    public static final String PAGE_URL = "/view/LocationView.jsf?faces-redirect=true";
    @Generated
    ...
    @Inject
    @Generated
    public LocationView(UserSession userSession, LocationBoundaryService locationService) {
     ...
     */
    @Generated
    public Collection<LocationSearchDTO> getLocationsList() {
     ...
     */
    @Generated
    public LocationSearchDTO getSelectedObject() {
     ...
     */
    @Generated
    public void setSelectedObject(LocationSearchDTO selectedObject) {
    ...
    public void onDoubleClick() {
        ...
        userSession.redirectTo(getCurrentPageURL(), openEditLocationDialog());
    }
    ...
    public void deleteLocation() {
        try {
            ...
            locationService.deleteLocation(selectedObject.getCode());
        }
    ...
    public String copy() {
        ...
        try {
            ...
            newId = locationService.copy(selectedObject.getCode(), userSession.getPrincipal().getId());
        }
        catch (final Exception e) {
        ...
        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = EditLocationDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(newId, java.nio.charset.StandardCharsets.UTF_8);
     ...
     */
    @Generated
    public String openCreateNewLocationDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = CreateNewLocationDialog.PAGE_INIT_URL;
     ...
     */
    @Generated
    public String openEditLocationDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = EditLocationDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObject.getCode(), java.nio.charset.StandardCharsets.UTF_8);
    ...
    public void initSearchObject() {
        ...
        final var field1 = new SearchFieldDTO(++colOrderId, LocationSearchDTO.SELECT_CODE,
                bundle.getString(LBL_ATTR_ABSTRACTFUNCTIONALACTIVEENTITY_CODE), SearchFieldDataTypeEnum.STRING, 80);
        searchObj.getSearchFields().add(field1);


        final var field2 = new SearchFieldDTO(++colOrderId, LocationSearchDTO.SELECT_SHORTTEXT,
        ...
        final var field3 = new SearchFieldDTO(++colOrderId, LocationSearchDTO.SELECT_COMMENT,
        ...
        final var field4 = new SearchFieldDTO(++colOrderId, LocationSearchDTO.SELECT_ACTIVE,
        ...
        final var field5 = new SearchFieldDTO(++colOrderId, LocationSearchDTO.SELECT_CREATIONDATE,
        ...
        final var field6 = new SearchFieldDTO(++colOrderId, LocationSearchDTO.SELECT_LASTUPDATE,
        ...
        try {
            locationsList = locationService.searchAllLocations(searchObj);
        }
        catch (final Exception e) {
    ...
    public void fetchLocations() {
        ...
        formTitle = bundle.getString(FORM_LOCATIONVIEW_TITLE);
