...
@Named("editRMATypeDialog")
@ViewScoped
public class EditRMATypeDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditRMATypeDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private RMATypeUpdateDTO rMAType;
    @Generated
    ...
    @Inject
    @Generated
    public EditRMATypeDialog(RMATypeBoundaryService rMATypeService, UserSession userSession) {
     ...
     */
    @Generated
    public RMATypeUpdateDTO getrMAType() {
        return rMAType;
    }
     ...
     */
    @Generated
    public void setrMAType(RMATypeUpdateDTO rMAType) {
    ...
    public void initView() {
        ...
        try {
            ...
            rMAType = rMATypeService.getRMATypeForUpdate(selectedObjectId);

            formTitle = bundle.getString(FORM_EDITRMATYPEDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String save() {
        try {
            ...
            rMATypeService.updateRMAType(rMAType);
    ...
    public String getCurrentPageURL() {
        return EditRMATypeDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
