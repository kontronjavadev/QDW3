...
@Named("plantView")
@ViewScoped
public class PlantView extends CopyClipboard implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    private List<PlantSearchDTO> plantsList = new ArrayList<>();
    @Generated
    private PlantSearchDTO selectedObject;
    @Generated
    private final UserSession userSession;
    @Generated
    private transient ResourceBundle bundle;
    @Generated
    private final transient PlantBoundaryService plantService;
    @Generated
    public static final String PAGE_URL = "/view/PlantView.jsf?faces-redirect=true";
    @Generated
    ...
    @Inject
    @Generated
    public PlantView(UserSession userSession, PlantBoundaryService plantService) {
     ...
     */
    @Generated
    public Collection<PlantSearchDTO> getPlantsList() {
        return plantsList;
    }
     ...
     */
    @Generated
    public PlantSearchDTO getSelectedObject() {
     ...
     */
    @Generated
    public void setSelectedObject(PlantSearchDTO selectedObject) {
    ...
    public void onDoubleClick() {
        ...
        userSession.redirectTo(getCurrentPageURL(), openEditPlantDialog());
    }
    ...
    public void deletePlant() {
        try {
            ...
            plantService.deletePlant(selectedObject.getCode());
        }
    ...
    public String copy() {
        ...
        try {
            ...
            newId = plantService.copy(selectedObject.getCode(), userSession.getPrincipal().getId());
        }
        catch (final Exception e) {
        ...
        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = EditPlantDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(newId, java.nio.charset.StandardCharsets.UTF_8);
     ...
     */
    @Generated
    public String openCreateNewPlantDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = CreateNewPlantDialog.PAGE_INIT_URL;
     ...
     */
    @Generated
    public String openEditPlantDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR))
            url = EditPlantDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObject.getCode(), java.nio.charset.StandardCharsets.UTF_8);
    ...
    public void initSearchObject() {
        ...
        final var field1 = new SearchFieldDTO(++colOrderId, PlantSearchDTO.SELECT_CODE,
        ...
        final var field2 = new SearchFieldDTO(++colOrderId, PlantSearchDTO.SELECT_SHORTTEXT,
        ...
        final var field3 = new SearchFieldDTO(++colOrderId, PlantSearchDTO.SELECT_COMMENT,
        ...
        final var field4 = new SearchFieldDTO(++colOrderId, PlantSearchDTO.SELECT_ACTIVE,
        ...
        final var field5 = new SearchFieldDTO(++colOrderId, PlantSearchDTO.SELECT_CREATIONDATE,
        ...
        final var field6 = new SearchFieldDTO(++colOrderId, PlantSearchDTO.SELECT_LASTUPDATE,
        ...
        try {
            plantsList = plantService.searchAllPlants(searchObj);
        }
        catch (final Exception e) {
    ...
    public void fetchPlants() {
        ...
        formTitle = bundle.getString(FORM_PLANTVIEW_TITLE);
