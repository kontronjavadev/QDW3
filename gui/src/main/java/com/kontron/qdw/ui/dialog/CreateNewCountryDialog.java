...
@Named("createNewCountryDialog")
@ViewScoped
public class CreateNewCountryDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/CreateNewCountryDialog.jsf?faces-redirect=true";
    @Generated
    private CountryCreateDTO country;
    @Generated
    ...
    @Inject
    @Generated
    public CreateNewCountryDialog(CountryBoundaryService countryService, UserSession userSession) {
     ...
     */
    @Generated
    public CountryCreateDTO getCountry() {
        return country;
    }
     ...
     */
    @Generated
    public void setCountry(CountryCreateDTO country) {
    ...
    public void initView() {
        ...
        try {
            ...
            formTitle = bundle.getString(FORM_CREATENEWCOUNTRYDIALOG_TITLE);
    ...
    public String getCurrentPageURL() {
        return CreateNewCountryDialog.PAGE_INIT_URL;
    }
