...
@Named("viewIllegalTraceBoMItemDialog")
@ViewScoped
public class ViewIllegalTraceBoMItemDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/ViewIllegalTraceBoMItemDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private IllegalTraceBoMItemDTO illegalTraceBoMItem;
    @Generated
     ...
     */
    @Generated
    public ViewIllegalTraceBoMItemDialog() {
    ...
    @Inject
    @Generated
    public ViewIllegalTraceBoMItemDialog(IllegalTraceBoMItemBoundaryService illegalTraceBoMItemService, UserSession userSession) {
     ...
     */
    @Generated
    public IllegalTraceBoMItemDTO getIllegalTraceBoMItem() {
        return illegalTraceBoMItem;
    }
     ...
     */
    @Generated
    public void setIllegalTraceBoMItem(IllegalTraceBoMItemDTO illegalTraceBoMItem) {
        this.illegalTraceBoMItem = illegalTraceBoMItem;
    }
    ...
    public void initView() {
        ...
        try {
            ...
            illegalTraceBoMItem = illegalTraceBoMItemService.findIllegalTraceBoMItemById(selectedObjectId);

            formTitle = bundle.getString(FORM_VIEWILLEGALTRACEBOMITEMDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String getCurrentPageURL() {
        return ViewIllegalTraceBoMItemDialog.PAGE_INIT_URL + selectedObjectId;
    }
    ...
    public String openViewTraceBoMDialogLink() {
        return ViewTraceBoMDialog.PAGE_INIT_URL + illegalTraceBoMItem.getTraceBom().getId();
    }
