...
@Named("createNewMaterialDialog")
@ViewScoped
public class CreateNewMaterialDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/CreateNewMaterialDialog.jsf?faces-redirect=true";
    @Generated
     ...
     */
    @Generated
    public CreateNewMaterialDialog() {
    ...
    @Inject
    @Generated
    public CreateNewMaterialDialog(MaterialBoundaryService materialService, UserSession userSession,
            MaterialClassBoundaryService materialClassService, MaterialTypeBoundaryService materialTypeService,
            LocationBoundaryService locationService) {
     ...
     */
    @Generated
    public MaterialCreateDTO getMaterial() {
        return material;
    }
     ...
     */
    @Generated
    public void setMaterial(MaterialCreateDTO material) {
    ...
    public void initView() {
        ...
        try {
            material = new MaterialCreateDTO();
            materialClassList = materialClassService.findMaterialClasses(null);

            if (!materialClassList.isEmpty())
                material.setMaterialClass(materialClassList.iterator().next());

            materialTypeList = materialTypeService.findMaterialTypes(null);

            if (!materialTypeList.isEmpty())
                material.setMaterialType(materialTypeList.iterator().next());

            ownerLocationList = locationService.findLocations(null);

            if (!ownerLocationList.isEmpty())
                material.setOwnerLocation(ownerLocationList.iterator().next());


            formTitle = bundle.getString(FORM_CREATENEWMATERIALDIALOG_TITLE);
    ...
    public String getCurrentPageURL() {
        return CreateNewMaterialDialog.PAGE_INIT_URL;
    }
