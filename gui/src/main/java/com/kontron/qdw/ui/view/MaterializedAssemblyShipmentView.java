...
@ViewScoped
public class MaterializedAssemblyShipmentView extends AbstractSearchableView implements Serializable {
    @Generated
    ...
    public void initSearchObject() {
        ...
        final var f11 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_SHIPMENTDATE,
        ...
        final var f12 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_ARRIVALDATE,
        ...
        final var f13 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_SUPPLIERCODE,
                bundle.getString(COL_MATERIALIZEDASSEMBLYSHIPMENTVIEW_SUPPLIERCODE), SearchFieldDataTypeEnum.STRING, 80);
        f13.setVisible(false);


        final var f14 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_SUPPLIERNAME,
        ...
        final var f15 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_SHIPMENTMOVEMENTTYPE,
        ...
        final var f16 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_ARRIVALMOVEMENTTYPE,
        ...
        final var f17 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_CUSTOMERORDERNUMBER,
        ...
        final var f18 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_PURCHASEORDERNUMBER,
        ...
        final var f19 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_MATERIALNUMBER,
        ...
        final var f20 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_SAPNUMBER,
                bundle.getString(COL_MATERIALIZEDASSEMBLYSHIPMENTVIEW_SAPNUMBER), SearchFieldDataTypeEnum.STRING, 150);
        f20.setVisible(false);


        final var f21 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_REVISIONNUMBER,
                bundle.getString(LBL_ATTR_MATERIALIZEDENTITIY_REVISIONNUMBER), SearchFieldDataTypeEnum.STRING, 150);
        f21.setVisible(false);


        final var f22 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_MATERIALHIERARCHY,
                bundle.getString(LBL_ATTR_MATERIALIZEDENTITIY_MATERIALHIERARCHY), SearchFieldDataTypeEnum.STRING, 150);
        f22.setVisible(false);


        final var f23 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_MATERIALSHORTTEXT,
                bundle.getString(LBL_ATTR_MATERIALIZEDENTITIY_MATERIALSHORTTEXT), SearchFieldDataTypeEnum.STRING, 250);
        f23.setVisible(false);


        final var f24 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_MATERIALTYPE,
                bundle.getString(COL_MATERIALIZEDASSEMBLYSHIPMENTVIEW_MATERIALTYPE), SearchFieldDataTypeEnum.STRING, 80);
        f24.setVisible(false);


        final var f25 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_PARENTMATERIALNUMBER,
        ...
        final var f26 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_PARENTSAPNUMBER,
        ...
        final var f27 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_PARENTMATERIALTYPE,
        ...
        final var f28 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_PARENTREVISIONNUMBER,
        ...
        final var f29 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_PARENTMATERIALHIERARCHY,
        ...
        final var f30 = new JSFSearchFieldDTO(searchObj, ++colOrderId, MaterializedAssemblyShipmentSearchDTO.SELECT_PARENTMATERIALSHORTTEXT,
