...
@Named("editFaultAnalysisDialog")
@ViewScoped
public class EditFaultAnalysisDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditFaultAnalysisDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private FaultAnalysisUpdateDTO faultAnalysis;
    @Generated
     ...
     */
    @Generated
    public EditFaultAnalysisDialog() {
    ...
    @Inject
    @Generated
    public EditFaultAnalysisDialog(FaultAnalysisBoundaryService faultAnalysisService, UserSession userSession) {
     ...
     */
    @Generated
    public FaultAnalysisUpdateDTO getFaultAnalysis() {
     ...
     */
    @Generated
    public void setFaultAnalysis(FaultAnalysisUpdateDTO faultAnalysis) {
     ...
     */
    @Generated
    public List<FaultAnalysisListDTO> onCompleteMappedTo(String filter) {
        try {
            return faultAnalysisService.findFaultAnalyses(filter);
        }
    ...
    public void initView() {
        ...
        try {
            ...
            faultAnalysis = faultAnalysisService.getFaultAnalysisForUpdate(selectedObjectId);

            formTitle = bundle.getString(FORM_EDITFAULTANALYSISDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String save() {
        try {
            ...
            faultAnalysisService.updateFaultAnalysis(faultAnalysis);
    ...
    public String getCurrentPageURL() {
        return EditFaultAnalysisDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
