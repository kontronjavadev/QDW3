...
@Named("editPlantDialog")
@ViewScoped
public class EditPlantDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/EditPlantDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private PlantUpdateDTO plant;
    @Generated
    ...
    @Inject
    @Generated
    public EditPlantDialog(PlantBoundaryService plantService, UserSession userSession) {
     ...
     */
    @Generated
    public PlantUpdateDTO getPlant() {
        return plant;
    }
     ...
     */
    @Generated
    public void setPlant(PlantUpdateDTO plant) {
        this.plant = plant;
    }
    ...
    public void initView() {
        ...
        try {
            ...
            plant = plantService.getPlantForUpdate(selectedObjectId);

            formTitle = bundle.getString(FORM_EDITPLANTDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String getCurrentPageURL() {
        return EditPlantDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
