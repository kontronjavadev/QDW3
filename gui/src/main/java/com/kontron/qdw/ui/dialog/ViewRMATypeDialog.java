...
@Named("viewRMATypeDialog")
@ViewScoped
public class ViewRMATypeDialog implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    public static final String PAGE_INIT_URL = "/dialog/ViewRMATypeDialog.jsf?faces-redirect=true&selectedObjectId=";
    @Generated
    private RMATypeDTO rMAType;
    @Generated
    ...
    @Inject
    @Generated
    public ViewRMATypeDialog(RMATypeBoundaryService rMATypeService, UserSession userSession) {
     ...
     */
    @Generated
    public void setrMAType(RMATypeDTO rMAType) {
    ...
    public void initView() {
        ...
        try {
            ...
            rMAType = rMATypeService.findRMATypeById(selectedObjectId);

            formTitle = bundle.getString(FORM_VIEWRMATYPEDIALOG_TITLE) + " '" + selectedObjectId + "'";
    ...
    public String getCurrentPageURL() {
        return ViewRMATypeDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObjectId, java.nio.charset.StandardCharsets.UTF_8);
    }
    ...
    public String openViewRMATypeDialogLink() {
        return ViewRMATypeDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(rMAType.getMappedTo().getCode(), java.nio.charset.StandardCharsets.UTF_8);
    }
