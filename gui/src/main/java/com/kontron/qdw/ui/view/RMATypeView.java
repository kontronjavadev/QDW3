...
@Named("rMATypeView")
@ViewScoped
public class RMATypeView extends CopyClipboard implements Serializable {
    @Generated
    private static final Logger logger = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    @Generated
    private static final long serialVersionUID = 1L;
    @Generated
    private List<RMATypeSearchDTO> rMATypesList = new ArrayList<>();
    @Generated
    private RMATypeSearchDTO selectedObject;
    @Generated
    ...
    @Generated
    public static final String PAGE_URL = "/view/RMATypeView.jsf?faces-redirect=true";
    @Generated
    ...
    @Inject
    @Generated
    public RMATypeView(UserSession userSession, RMATypeBoundaryService rMATypeService) {
     ...
     */
    @Generated
    public Collection<RMATypeSearchDTO> getrMATypesList() {
        return rMATypesList;
    }
     ...
     */
    @Generated
    public RMATypeSearchDTO getSelectedObject() {
     ...
     */
    @Generated
    public void setSelectedObject(RMATypeSearchDTO selectedObject) {
    ...
    public void onDoubleClick() {
        ...
        userSession.redirectTo(getCurrentPageURL(), openEditRMATypeDialog());
    }
     ...
     */
    @Generated
    public void deleteRMAType() {
        try {
            logger.debug("Delete selected object with id '{}'", selectedObject.getCode());

            rMATypeService.deleteRMAType(selectedObject.getCode());
        }
    ...
    public String copy() {
        ...
        try {
            ...
            newId = rMATypeService.copy(selectedObject.getCode(), userSession.getPrincipal().getId());
        }
        catch (final Exception e) {
        ...
        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = EditRMATypeDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(newId, java.nio.charset.StandardCharsets.UTF_8);
        }
     ...
     */
    @Generated
    public String openCreateNewRMATypeDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = CreateNewRMATypeDialog.PAGE_INIT_URL;
        }
     ...
     */
    @Generated
    public String openEditRMATypeDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = EditRMATypeDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObject.getCode(), java.nio.charset.StandardCharsets.UTF_8);
        }
     ...
     */
    @Generated
    public String openViewRMATypeDialog() {
        var url = "";

        if (userSession.checkAuthorization(false, ROLE_ADMINISTRATOR)) {
            url = ViewRMATypeDialog.PAGE_INIT_URL + java.net.URLEncoder.encode(selectedObject.getCode(), java.nio.charset.StandardCharsets.UTF_8);
        }
    ...
    public void initSearchObject() {
        ...
        final var field1 = new SearchFieldDTO(++colOrderId, RMATypeSearchDTO.SELECT_CODE, bundle.getString(LBL_ATTR_ABSTRACTFUNTIONALENTITY_CODE),
                SearchFieldDataTypeEnum.STRING, 100);
        searchObj.getSearchFields().add(field1);


        final var field2 = new SearchFieldDTO(++colOrderId, RMATypeSearchDTO.SELECT_SHORTTEXT,
        ...
        final var field3 = new SearchFieldDTO(++colOrderId, RMATypeSearchDTO.SELECT_COMMENT,
        ...
        final var field4 = new SearchFieldDTO(++colOrderId, RMATypeSearchDTO.SELECT_CREATIONDATE,
        ...
        final var field5 = new SearchFieldDTO(++colOrderId, RMATypeSearchDTO.SELECT_LASTUPDATE,
        ...
        try {
            rMATypesList = rMATypeService.searchAllRMATypes(searchObj);
        }
        catch (final Exception e) {
    ...
    public void fetchRMATypes() {
        ...
        formTitle = bundle.getString(FORM_RMATYPEVIEW_TITLE);
