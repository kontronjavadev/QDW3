...
@Named("movementTypeListDTOConverter")
@RequestScoped
public class MovementTypeListDTOConverter implements Converter<MovementTypeListDTO> {
    @Generated
    ...
    @Override
    @Generated
    public MovementTypeListDTO getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue == null || submittedValue.isEmpty() || submittedValue.equals(NON_BREAKING_SPACE))
            return null;

        return new MovementTypeListDTO(submittedValue);
    }
    ...
    @Override
    @Generated
    public String getAsString(FacesContext facesContext, UIComponent component, MovementTypeListDTO value) {
        if (value == null)
            return null;
