...
public class TraceBoMMappingType implements Serializable, TraceBoMTypeIF<TraceBoMItemMappingType> {

    private static final long serialVersionUID = 341886962449041859L;
