...
public class Supplier extends AbstractFuntionalEntity {
    ...
    @Generated
    public static final String NQ_DELETE_ALL = "Supplier.deleteAll";
    @Generated
    public static final String NQ_GET_COUNTRY = "Supplier.getCountry";
    @Generated
    public static final String NQ_COUNT = "Supplier.count";
    @Generated
    public static final String NQ_DELETE = "Supplier.delete";
    @Generated
    public static final String NQ_GET_ALL = "Supplier.getAll";
    @Generated
