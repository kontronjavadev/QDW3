...
@Entity
@Table(name = "assembly_shipment_mv")
@NamedQuery(name = MaterializedAssemblyShipment.NQ_GET_MATERIAL, query = "select b from MaterializedAssemblyShipment a join a.material b where a.id = :id")
@NamedQuery(name = MaterializedAssemblyShipment.NQ_GET_SERIALOBJECT, query = "select b from MaterializedAssemblyShipment a join a.serialObject b where a.id = :id")
@NamedQuery(name = MaterializedAssemblyShipment.NQ_DELETE_ALL, query = "delete from MaterializedAssemblyShipment a")
@NamedQuery(name = MaterializedAssemblyShipment.NQ_DELETE, query = "delete from MaterializedAssemblyShipment a where a.id = :id")
@NamedQuery(name = MaterializedAssemblyShipment.NQ_GET_ALL, query = "select a from MaterializedAssemblyShipment a")
@NamedQuery(name = MaterializedAssemblyShipment.NQ_FIND, query = "select a from MaterializedAssemblyShipment a where a.id = :id")
@NamedQuery(name = MaterializedAssemblyShipment.NQ_CHECK, query = "select count(a) from MaterializedAssemblyShipment a where a.id = :id")
@NamedQuery(name = MaterializedAssemblyShipment.NQ_COUNT, query = "select count(a) from MaterializedAssemblyShipment a")
public class MaterializedAssemblyShipment extends MaterializedEntitiy {
    @Generated
    public static final String NQ_GET_SERIALOBJECT = "MaterializedAssemblyShipment.getSerialObject";
    @Generated
    public static final String NQ_DELETE_ALL = "MaterializedAssemblyShipment.deleteAll";
    @Generated
    public static final String NQ_COUNT = "MaterializedAssemblyShipment.count";
    @Generated
    public static final String NQ_DELETE = "MaterializedAssemblyShipment.delete";
    @Generated
    public static final String NQ_GET_ALL = "MaterializedAssemblyShipment.getAll";
    @Generated
    public static final String NQ_GET_MATERIAL = "MaterializedAssemblyShipment.getMaterial";
    @Generated
    public static final String NQ_CHECK = "MaterializedAssemblyShipment.check";
    @Generated
    public static final String NQ_FIND = "MaterializedAssemblyShipment.find";
     ...
     */
    @Generated
    public MaterializedAssemblyShipment() {
    }
     ...
     */
    @Generated
    public MaterializedAssemblyShipment(long id) {
        super(id);
    }
    ...
    public boolean equals(Object obj) {
        ...
        final var bean = (MaterializedAssemblyShipment) obj;
